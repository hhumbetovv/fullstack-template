...
- Deliver SVG icons only with fill-based paths. Stroke-based drawings get distorted during font generation; apply “Outline Stroke” in Figma or use a tool like Inkscape to convert strokes to paths before committing.
