...
class WorkspaceDiscoveryAdapter implements ModuleDiscoveryPort {
  const WorkspaceDiscoveryAdapter();
  ...
  bool _isUnderTemplate(String path, String templatesRoot) {
    return path == templatesRoot || path.startsWith('$templatesRoot${Platform.pathSeparator}');
  }
}
